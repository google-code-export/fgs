FGS.giftsArray = {
	...
	'102452128776': // farmville
	{
		...
		"animalfeedtrough_feed": { name: 'Animal Feed'},
	...
	{
		"item_saltwater": { name: 'Salt Water'},
		"item_sweetwater": { name: 'Sweet Water'},
		"item_bubblywater": { name: 'Bubbly Water'},
		"item_sardines": { name: 'Sardines'},
		"item_anchovies": { name: 'Anchovies'},
		"item_redherrings": { name: 'Red Herrings - lvl Coming soon!'},
		"delivery_crate": { name: 'Special Delivery'},
		"item_eggdye1": { name: 'Egg Dye'},
		"mystery_gift": { name: 'Mystery Gift'},
		"item_surfwax1": { name: 'Surf Wax'},
		"fruit_kiwi": { name: 'Kiwis - lvl 3'},
		"fruit_banana": { name: 'Bananas - lvl 10'},
		"fruit_mango": { name: 'Mangoes - lvl 15'},
		"oxygen_bottle": { name: 'Oxygen Bottle - lvl 4'},
		...
		"construction_coconutmilk": { name: 'Coconut Milk'},
		"construction_straw": { name: 'Straws'},
		"construction_umbrella": { name: 'Umbrellas'},
		"construction_terravitae": { name: 'Terra Vitae'},
	...
	120563477996213: // ravenwood fair
	{
		...
		"280": { name: 'Tree Sap'},
		"281": { name: 'Vitalin'},
		"375": { name: 'Wedding Gift'},
		"377": { name: 'Wedding Bell'},
		"608": { name: 'Catnip'},
		"655": { name: 'Heart'},
		"710": { name: 'Daffodil - lvl 8'},
		"712": { name: 'RSVP'},
		"759": { name: 'Gear'},
		"791": { name: 'Easter Egg'},
		"875": { name: 'Brick - lvl 10'},
		"876": { name: 'Gold - lvl 10'},
		"877": { name: 'Platinum - lvl 10'},
		"878": { name: 'Emerald - lvl 10'},
		"880": { name: 'Diamond - lvl 10'},
		"923": { name: 'Wisteria'},
		"202": { name: 'Round Bush'},
		"204": { name: 'White Picket Fence'},
		"319": { name: 'Clean Grass'},
		"330": { name: 'Balloons'},
		"214": { name: 'Tall Grass - lvl 2'},
		"223": { name: 'Roses - lvl 2'},
		"219": { name: 'Wooden Picnic Table - lvl 3'},
		"209": { name: 'Giant Pumpkins - lvl 4'},
		"441": { name: 'Small Green Tent - lvl 4'},
		"230": { name: 'Barrel Cacti - lvl 5'},
		"364": { name: 'Petal Path - lvl 5'},
		"212": { name: 'Aspen Tree - lvl 6'},
		"232": { name: 'Skeleton - lvl 7'},
		"247": { name: 'Square Hedge - lvl 8'},
		"237": { name: 'Dark Stone Path - lvl 9'},
		"822": { name: 'Empty Minecart - lvl 9'},
		"251": { name: 'Marble Path - lvl 10'},
		"823": { name: 'Minecart Track - lvl 10'},
		"627": { name: 'Danger Sign - lvl 11'},
		"234": { name: 'Bongo Drums - lvl 12'},
		"837": { name: 'Medium Crate - lvl 12'},
		"526": { name: 'Vinca Vine - lvl 13'},
		"530": { name: 'Picnic Umbrella - lvl 14'},
		"850": { name: 'Wooden Chair - lvl 16'},
		"602": { name: 'Cat Print Tile - lvl 19'},
	},
	151044809337: // fishville
	{
		"genericribbonindigo": { name: 'Special Indigo Ribbon'},
		"greenBrainCoral": { name: 'Green Brain Coral'},
		"easterlily_pinkeasterlily": { name: 'Pink Lily'},
		"magnificentrabbitfish": { name: 'Magnificent Rabbitfish'},
		"mysterybox": { name: 'Mystery Box'},
		"oyster_mysterybox": { name: 'Mystery Oyster'},
		"tools": { name: 'Tool'},
		"pholamphanging2": { name: 'Teal Lamp'},
		"foodMedicine1": { name: 'Medicine'},
		"dsabubblegumcoral": { name: 'Bubble Gum Coral'},
		"galhmsbeagle": { name: 'HMS Beagle'},
		"klfreefcollection1": { name: 'Live Rock'},
		"xmascakehouse": { name: 'Snow Cake'},
		"dsapicassosponge": { name: 'Picasso Sponge'},
		"reef_mossywheel": { name: 'Mossy Wheel'},
		"shelf": { name: 'Shelf'},
		"reef_whitebranchcoral": { name: 'White Branch Coral'},
	...
	291549705119: // cityville
	{
		...
		"material_folders": { name: 'Manila Folder'},
		"material_inkpad": { name: 'Inkpad'},
		"material_visor": { name: 'Visor'},
		"material_whistle": { name: 'Whistle'},
		"material_deck_chair": { name: 'Deck Chair'},
		"material_ribbon": { name: 'Ribbon'},
		"material_city_seal": { name: 'City Seal'},
		"material_gold_plating": { name: 'Gold Plating'},
		"material_robotic_arm": { name: 'Robotic Arm'},
		"material_work_uniforms": { name: 'Work Uniform'},
		"material_lunchbox": { name: 'Lunchbox'},
		"deco_italianpiazza_tilefence": { name: 'Piazza Guardrail'},
		"deco_bikerack": { name: 'Bike Rack'},
		"deco_clover_flowers": { name: 'Blossoming Clovers'},
		"deco_clovertopiary": { name: 'Clover Topiary'},
		"deco_streetclock": { name: 'Street Clock'},
		"deco_kiddieride_horse": { name: 'Racing Ride'},
	...
	{
		"1": { name: "Mystery Faerie Gift!"},
		"2": { name: "Mystery Beast Gift!"},
		"3": { name: "Mystery Symbol Gift!"},
		"4": { name: "Mystery Shield Gift!"},
		"5": { name: "Dragon Egg!"},
		"6": { name: "Serpent Egg!"},
		"7": { name: "Mystery Air Gift!"},
		"8": { name: "Mystery Trident Gift!"},
		"9": { name: "Mystery Robe Gift!"},
		"10": { name: "Mystery Cloak Gift!"},
		"11": { name: "Mystery Dagger Gift!"},
		"12": { name: "Mystery Axe Gift!"},
		"13": { name: "Mystery Heirloom Gift!"},
		"14": { name: "Mystery Staff Gift!"},
		"15": { name: "Mystery Shield Gift!"},
		"16": { name: "Mystery Lava Gift!"},
		"17": { name: "Mystery Crest Piece!"},
		"18": { name: "Mystery Plate Gift!"},
		"19": { name: "Great Fiery Gift!"},
		"20": { name: "Volcanic Egg!"},
		"21": { name: "Mystery Ice Artifact!"},
		"22": { name: "Mystery Earth!"},
		"23": { name: "Mystery Relic!"},
		"24": { name: "Mystery Item!"},
		"25": { name: "Limited Dragan Gift!"},
		"26": { name: "Mystery Relic!"},
		"27": { name: "Mystery Treasure!"},
		"28": { name: "Mystery Frost Relic!"},
		"29": { name: "Mystery Fire Relic!"},
		"30": { name: "Mystery Heirloom!"},
		"31": { name: "Mystery Blade Gift!"},
		"32": { name: "Mystery Locket Gift!"},
		"33": { name: "Mystery Gift!"},
		"34": { name: "Mystery Relic!"},
		"35": { name: "Mystery Tome!"},
	},
	...
	156383461049284://farmville chinese
	{
		"socialplumbingmysterygift": { name: '特別快遞'},
		"kissJamGift": { name: '种“草莓” 還剩 1 天'},
		"socialplumbingmysterygift": { name: '特別快遞'},
		"wateringcan": { name: '澆水罐'},
		"stpattysbasket2011_gold_5": { name: '金幣'},
		"stpattysbasket2011_gold_1": { name: '金條'},
		"stpattysbasket2011_gold_2": { name: '大金塊'},
		"stpattysbasket2011_gold_4": { name: '金色豎琴'},
		"stpattysbasket2011_gold_3": { name: '小金塊'},
	...
	21526880407: // yoville
	{
		...
		"42166": { name: 'Vegas Multicolor Light'},
		"42165": { name: 'Vegas Guitar'},
		"42046": { name: 'Vegas Mystery Box'},
		"41932": { name: 'Easter Mystery Egg'},
		...
		"31828": { name: 'Green Mystery Chest'},
	...
	{
		"1171": { name: 'Giants Lip Balm'},
		"1170": { name: 'Thimble Chair'},
	...
	{
		"Energy": { name: "Small energy pack"},
		"SupplyPack": { name: "Small supply pack"},
		"AllyReport": { name: "Ally Report"},
		"Medal1": { name: "Bronze Cross"},
	},
	...
	112775362105084: // animal party
	{
		"mb_4": { name: "Mystery Box"},
		"mb_1": { name: "Bait Box"},
		"mb_11": { name: "Resource Box"},
		"ing_545": { name: "Flower"},
		"ing_38": { name: "Stardust"},
		"epack_3001": { name: "Small Battery Pack"},
		"ing_547": { name: "Simple Key"},
		"ing_1": { name: "Basic Cloth"},
		"ing_4": { name: "Softwood"},
		"ing_7": { name: "Sparkle Ore"},
		"ing_10": { name: "Moonrock"},
		"ing_13": { name: "Quartz Crystal"},
		"ing_403": { name: "Marble"},
		"ing_29": { name: "Feather"},
		"ing_66": { name: "Mud"},
		"ing_67": { name: "Pebble"},
		"ing_68": { name: "Shell"},
		"ing_69": { name: "Straw"},
		"ing_20": { name: "Sweetwater"},
		"ing_70": { name: "Grease"},
		"ing_72": { name: "Grass"},
		"decoration_501": { name: "Greystone Wall"},
		"decoration_502": { name: "Alabaster Wall"},
		"decoration_503": { name: "Brick Wall"},
		"decoration_504": { name: "Haystack"},
	},
	216230855057280:
	{
		"delightful_bow": { name: "Delightful Bow"},
		"precious_butterfly": { name: "Precious Butterfly"},
		"ruby_snowflake": { name: "Ruby Snowflake"},
		"fire_and_ice": { name: "Fire and Ice"},
		"majorelle_blue": { name: "Majorelle Blue"},
		"turquoise_pearls": { name: "Turquoise Pearls"},
		"amber_spirit": { name: "Amber Spirit"},
		"carnelian_monarch": { name: "Carnelian Monarch"},
		"dainty_emerald": { name: "Dainty Emerald"},
		"delicate_touch": { name: "Delicate Touch"},
		"elegant_touch": { name: "Elegant Feel"},
		"green_birdwing": { name: "Green Birdwing"},
		"majestic_look": { name: "Majestic Look"},
		"onyx_love": { name: "Onyx Love"},
		"precious_feel": { name: "Precious Feel"},
		"beach_marble": { name: "Amber Marble"},
		"delicate_flowers": { name: "Delicate Flowers"},
		"silver_beauty": { name: "Silver Beauty"},
		"swirling_ocean": { name: "Swirling Ocean"},
		"majestic_sparkle": { name: "Majestic Sparkle"},
		"exquisite_ruby": { name: "Exquisite Ruby"},
		"sapphire_delight": { name: "Sapphire Delight"},
		"simply_gorgeous": { name: "Simply Gorgeous"},
		"big_money": { name: "Big Money"},
		"butterfly": { name: "Butterfly"},
		"diamond_a": { name: "Diamond 'A'"},
		"diamond_flower": { name: "Diamond Flower"},
		"sapphire_brooch": { name: "Sapphire Brooch"},
		"sunshine_state": { name: "Sunshine State"},
		"royal_crown": { name: "Royal Crown"},
		"antique_emerald": { name: "Antique Emerald"},
		"rare_flower": { name: "Rare Find"},
		"treble_clef": { name: "Treble Clef"},
		"emerald_beetle": { name: "Emerald Beetle"},
		"clover_hearts": { name: "Clover Hearts"},
		"golden_heart": { name: "Golden Heart"},
		"irish_heart": { name: "Irish Heart"},
		"lolly_heart": { name: "Lolly Heart"},
		"pearl_heart": { name: "Pearl Heart"},
		"rainbow_flower": { name: "Rainbow Flower"},
		"rosy_heart": { name: "Rosy Heart"},
		"letter_A": { name: "letter A"},
		"letter_B": { name: "letter B"},
		"letter_D": { name: "letter D"},
		"letter_F": { name: "letter F"},
		"letter_N": { name: "letter N"},
		"letter_U": { name: "letter U"},
		"letter_V": { name: "letter V"},
