		...
		$.ajax({
			...
			success: function(dataStr)
			{
				try
				{
					...
					if(exclude == '')
						FGS.adventureworld.Freegifts.Finish(params);
					else					
						FGS.adventureworld.Freegifts.Click4(params);
		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				{	
					...
					FGS.adventureworld.Requests.Click2(currentType, id, url, params);
				}
				catch(err)
				{
					FGS.dump(err);
