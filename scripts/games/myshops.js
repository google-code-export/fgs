	...
	Click: function(currentType, id, currentURL, retry)
	{
		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				try
				{
					info.image 	= $('#app123837014322698_giftImage',dataHTML).children('img:first').attr('path');
		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				try
				{
					...
					{
						info.image  = $('#app123837014322698_rewardImage', dataHTML).children('img:first').attr('path');
