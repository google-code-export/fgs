		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				try
				{
					...
					{
						info.image = $(".giftFrom_img",dataHTML).children().attr("path");
					...
					{
						info.image = 'http://fb-client-0.cityville.zynga.com/'+$(".train_reward_icon",dataHTML).children().attr("path");
					...
					{
						info.image 	= $(".img_container",dataHTML).children().attr("path");
