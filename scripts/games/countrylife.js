		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				try
				{
					...
					FGS.countrylife.Freegifts.Click2(params);
				}
				catch(err)
				{
					FGS.dump(err);
		...
		$.ajax({
			...
			success: function(dataStr)
			{
				try
				{
					...
					FGS.countrylife.Freegifts.Click3(params);
				}
				catch(err)
				{
					FGS.dump(err);
		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				{	
					...
					FGS.countrylife.Freegifts.ClickRequest(params);
				}
				catch(err)
				{
					FGS.dump(err);
		...
		$.ajax({
			...
			success: function(dataStr)
			{
				...
				try 
				{
					...
					FGS.countrylife.Requests.Click2(currentType, id, url, params);
				} 
				catch(err)
				{
					FGS.dump(err);
