		...
		$.ajax({
			...
			success: function(dataStr)
			{
				try
				{
					...
					{
						info.image = $('#neighbor_image', dataHTML).children('img').attr('path');
					...
					{
						info.image = $('#acceptInfo', dataHTML).children('img').attr('path');
